<div wire:key='{{ $todo->id }}'
    ...
    <div class="flex justify-between space-x-2">
        <div class="flex items-center">
            ...
            @if ($editID === $todo->id)
                <input type="text" placeholder="Todo.." wire:model='editTodoName'
    ...
    <div class="mt-3 text-xs text-gray-700">
        @if ($editID === $todo->id)
            <button wire:click='update'
                class="mt-3 px-4 py-2 bg-teal-500 text-white font-semibold rounded hover:bg-teal-600">Updat</button>
